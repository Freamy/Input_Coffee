public class Robot implements Mezonallo{
	...
	public void lep(Sebesseg valtozas, String olajfoltNeve, String ragacsNeve){
		if(!megsemmisult) {
		if (vesztettem) {
	...
	public void ragacsotTesz(String ragacsneve){
		...
		Ragacs ragacs = new Ragacs(ragacsneve, pozicio, 1, kord);
		ragacsDb--;
		}
		}
	}
	...
	public void olajfoltotTesz(String olajfoltneve){
		...
		int kord[] = navigator.koordinataKonverter(pozicio);
		Olajfolt olajfolt = new Olajfolt(olajfoltneve, pozicio, 1, kord);
		olajDb--;
		}
		}
	}
